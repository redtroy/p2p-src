...
public class PostServiceImpl implements IPostService
{
    ...
    public String getSignMsg(OrderModel orderMember) throws ServiceException
    {
        ...
        try
        {
            ...
            if (null != orderMember.getInputCharset()
                    && !"".equals(orderMember.getInputCharset()))
            {
            ...
            if (null != orderMember.getLanguage()
                    && !"".equals(orderMember.getLanguage()))
            {
            ...
            if (null != orderMember.getProductPrice()
                    && !"".equals(orderMember.getProductPrice()))
            {
                requestOrder.setProductPrice(Long.parseLong(orderMember.getProductPrice()));
            }
            if (null != orderMember.getProductNum()
                    && !"".equals(orderMember.getProductNum()))
            {
