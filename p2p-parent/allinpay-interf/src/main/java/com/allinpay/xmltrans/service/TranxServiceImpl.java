...
public class TranxServiceImpl
{
     ...
     * @throws Exception 
     */
    public void batchTranx(String url, String trx_code, String busicode,
    ...
    public void nistTest(String url, String trx_code, String busicode,
            Trans_Detail trans_detail, boolean isTLTFront) throws Exception
    {
    ...
    private InfoReq makeReq(String trxcod)
    {
        ...
        info.setREQ_SN(tranxContants.merchantId + "-"
        ...
        info.setDATA_TYPE("2");
        info.setVERSION("03");
        if ("300000".equals(trxcod) || "300001".equals(trxcod)
                || "300003".equals(trxcod) || "220001".equals(trxcod)
                || "220003".equals(trxcod))
        {
    ...
    {
        xml = XmlTools.signMsg(xml,
                tranxContants.pfxPath,
                tranxContants.pfxPassword,
                false);
        return xml;
    }
     ...
     * @throws Exception 
     */
    public boolean verifyMsg(String msg, String cer, boolean isFront)
            throws Exception
    {
    ...
    private void writeBill(String resp) throws Exception
    {
        ...
        Base64InputStream b64is = new Base64InputStream(
                IOUtils.toInputStream(billContext), false);
    ...
    */
     ...
     * 下载简单对账文件
     */
    public void downSimpleBills(String uRL11, boolean isTLTFront)
            throws Exception
    {
        ...
        SIGN = XmlTools.signPlain(CONTFEE,
                tranxContants.getPfxPath(),
                tranxContants.getPfxPassword(),
                false);
        uRL11 = uRL11.replaceAll("@xxx", SETTDAY)
                .replaceAll("@yyy", REQTIME)
                .replaceAll("@zzz", MERID)
                .replaceAll("@sss", SIGN);
     ...
     * @throws Exception 
     */
    public void queryTradeNew(String url, String reqsn, boolean isTLTFront,
     ...
     *  功能： 历史余额查询 300001
     */
    public void merAcctBalance(String url, boolean isTLTFront,
    ...
    public void dealRet(String retXml)
    {
        ...
        if ("100011".equals(trxcode) || "100014".equals(trxcode))
        {
            if ("0000".equals(aipgrsp.getINFO().getRET_CODE()))
            {
                ...
                System.out.println("交易结果：" + ret.getRET_CODE() + ":"
                        + ret.getERR_MSG());
     ...
     * @throws Exception 
     */
    public void singleAcctVerify(String url, boolean isTLTFront)
            throws Exception
    {
        String xml = "";
        AipgReq aipgReq = new AipgReq();
     ...
     * @throws Exception 
     */
    public void batchAcctVerify(String url, boolean isTLTFront)
            throws Exception
    {
        String xml = "";
        AipgReq aipgReq = new AipgReq();
